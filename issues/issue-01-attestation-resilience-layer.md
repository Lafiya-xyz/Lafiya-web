...
- Classic circuit-breaker state machine reference: Michael Nygard, _Release It!_ (CLOSED/OPEN/HALF-OPEN pattern) — the test file's exact thresholds (3 failures, 30s cooldown) are the spec to satisfy.
