...
- Adding CAPTCHA, WebAuthn, or other secondary auth-hardening mechanisms — this issue is scoped to making the existing rate-limit _mechanism_ actually work as designed, not to adding new defenses.
