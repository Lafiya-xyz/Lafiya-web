...
- `app/api/attestation/[recordHash]/route.ts` and `lib/stellar/attestation.ts` only ever _read_ attestation state; nothing in the repo _writes_ or _observes_ on-chain writes.
