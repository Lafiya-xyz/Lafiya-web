...
- Building the actual CHW re-attestation UI/tool (`lafiya-verifier`) — you only need to wire the patient-facing "request re-verification" trigger to _something_ real and testable (e.g., a queued request record), not a full CHW-side experience.
